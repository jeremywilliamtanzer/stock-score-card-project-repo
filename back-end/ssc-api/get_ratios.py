...
@api.get('/my_calc')
def my_calc(feature1, features2, features3, features4, features5):
    return {'results': (float(feature1) + float(features2) + float(features3), float(features4), float(features5))}
